...
public class Test {
    ...
    public static void main(String[] args)  {
        ...
        destMoveup.setZoom(0);// to set the zoom % of landing page as 100
        destMoveup.setTop(new Float(page1.getMediaBox().getHeight()).intValue());// to move to the top of the lonked
        // page
        ...
        // A clickable rectangle is created around the image. Below code is to remove
        // the border of that rectangle
        ...
        /*
         * contentStream1.setNonStrokingColor(Color.black); contentStream1.addRect(300,
         * 514, 245, 255); contentStream1.fill();
         */
        ...
        if (bodyAge > age + 5) {
            pdImage = PDImageXObject.createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/forgetfulman.png",
                    document);
        } else {
        ...
        contentStream1.showText("Sab Theek");
        ...
        /*
         * contentStream1.drawLine(54,436,540,436); contentStream1.setLineWidth(100.0f);
        ...
        /*
         * contentStream1.setNonStrokingColor(Color.black); contentStream1.addRect(392,
         * , 180, 32); contentStream1.fill();
         */
            ...
            if (bodyFat >= 10 && bodyFat <= 20) {
                ...
                if (age > 40) {
                    pdImage = PDImageXObject
                            .createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/face-1.png", document);
                } else {
                    pdImage = PDImageXObject
                            .createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/face-1.png", document);
                }
                ...
                if (age > 40) {
                    ...
                    pdImage = PDImageXObject.createFromFile(
                            "C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/face-1.png", document);
                }
            } else if (bodyFat > 20) {
				/*pdImage = PDImageXObject.createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/star-6.png", document);
				contentStream1.drawImage(pdImage, 65, 192);*/
                if (age > 40) {
                    pdImage = PDImageXObject.createFromFile(
                            "C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/face-1.png", document);
        ...
        if (systol >= 75 && systol <= 85 && dystol >= 110 && dystol <= 130) {
			/*pdImage = PDImageXObject.createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/star-2.png", document);
        ...
        } else if (metabolicRate >= 40 && metabolicRate < 70) {
			/*pdImage = PDImageXObject.createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/star-4.png", document);
			contentStream1.drawImage(pdImage, 468, 192);*/
        ...
        // pdImage =
        // PDImageXObject.createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/star-1.png",
        // document);
        // contentStream1.drawImage(pdImage, 65, 192);
        // pdImage =
        // PDImageXObject.createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/star-2.png",
        // document);
        // contentStream1.drawImage(pdImage, 198, 192);
        // pdImage =
        // PDImageXObject.createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/star-3.png",
        // document);
        // contentStream1.drawImage(pdImage, 333, 192);
        // pdImage =
        // PDImageXObject.createFromFile("C:/Users/avishaji996/workspace/RHI_PDF/src/main/resources/images/star-4.png",
        // document);
        // contentStream1.drawImage(pdImage, 468, 192);
        ...
        /*
         * contentStream2.setNonStrokingColor(239,62,91); contentStream2.addRect(0, 0,
         * 595, 842); contentStream2.fill();
         */
        ...
        contentStream3.newLine();
        contentStream3.showText("just as bad. Also, the distribution of body fat in men");
        contentStream3.newLine();
        ...
        contentStream3.setLeading(16);
        contentStream3.newLine();
        contentStream3.showText("of high and low body fat.");
        contentStream3.newLine();
        ...
        contentStream5.newLineAtOffset(50, 560);
        contentStream5.showText(bloodPressure.toString());
        contentStream5.endText();
        contentStream5.beginText();
        ...
        contentStream6.showText("Resting Metabolism(BMR)");
        ...
        contentStream6.showText("Resting metabolism(BMR) is the minimal level of energy");
        ...
        lines.add("eating leafy vegetables, fruits, whole grains and fat-free or low-fat dairy products,");
        lines.add("including lean meats, poultry, fish, beans, eggs and nuts, limiting saturated and trans");
        ...
        contentStream7.showText("fats, sodium and added sugars, controlling portion sizes.");
        contentStream7.endText();
        ...
        contentStream7.setNonStrokingColor(Color.WHITE);
        contentStream7.showText("Disclaimer:");
        ...
        String documentName = "D:/KaradaPDFRepo/RHI_HealthReport_" + System.currentTimeMillis() + ".pdf";
